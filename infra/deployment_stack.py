...
class DeploymentStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs):
        ...
        db_secret = secrets.Secret(self, "DbCredentials",
        ...
        # RDS MySQL Database
        database = rds.DatabaseInstance(self, "CapstoneDB",
            ...
            removal_policy=Stack.of(self).node.try_get_context("retain_resources") and Stack.of(self).RETAIN or Stack.of(self).DESTROY
        )
        ...
        CfnOutput(self, "DatabaseSecretArn",
